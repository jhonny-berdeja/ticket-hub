...
# GITHUB_STEP_SUMMARY for release-ticket-hub.yml. Prints Markdown to
# stdout -- appending it to $GITHUB_STEP_SUMMARY is the caller's job
# (in release-ticket-hub.yml), not this script's.
#
...
echo ""
echo "**[▶ Ver los tags en Docker Hub](https://hub.docker.com/r/$DOCKERHUB_USERNAME/ticket-hub/tags)**"
