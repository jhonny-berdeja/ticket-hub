...
# section for release-ticket-hub.yml. Prints Markdown to stdout -- appending
# it to $GITHUB_STEP_SUMMARY is the caller's job (in release-ticket-hub.yml),
# not this script's.
#
...
echo ""
echo "**[▶ Ver el run de deploy en infra-hub](https://github.com/$REPOSITORY_OWNER/infra-hub/actions/workflows/deploy-ticket-hub.yml)**"
